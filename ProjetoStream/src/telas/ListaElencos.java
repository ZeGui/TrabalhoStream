 ...
 * @author josel
 */
public class ListaElencos extends javax.swing.JFrame {

    /**
     * Creates new form ListaElencos
     */
    public ListaElencos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaElencos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaElencos().setVisible(true);
            }
        });
    }
